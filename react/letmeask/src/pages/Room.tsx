        ...
        <div id="page-room">
            <header>
                <div className="content">
                    ...
                    <img src={logoImg} alt="" />
                    <RoomCode code={roomId} link={window.location.href}/>
                </div>
            </header>
                ...
                <form onSubmit={handleSendQuestion}>
                    ...
                    <div className="form-footer">
                        { user ? (
                            ...
                            <span>Para enviar uma pergunta <button onClick={signInWithGoogle}>faca seu login</button> </span>
                        ) }
                            ...
                            >
                                {!question.isAnswered && (
                                    <button 
                                        ...
                                        onClick={() => handleLikeQuestion(question.id, question.likeId)} //forma de passar função com parametro
                                    >
